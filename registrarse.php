...
<head>
    ...
    <style>
        body {
            background-image: url('https://acortar.link/YlHt7p');
                ...
                <div class="card mt-5">
                    ...
                    <div class="card-body">
                        <form action="registrarse.php" method="post">
                            ...
                            <button type="submit" class="btn btn-success btn-block"><i class="fas fa-user-plus"></i> Registrarse</button>
                        </form>
                    </div>
                    ...
                    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                        ...
                        if ($password === $confirm_password) {
                            ...
                            $usuario = new Usuario(null, $username, $hashed_password, $email);
                            $stmt = $pdo->prepare("INSERT INTO usuarios (nombre, clave, email) VALUES (?, ?, ?)");
